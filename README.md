...
This quick start guide demonstrates how to build an example Flask To-Do app with the [Azure Cosmos DB Emulator](https://docs.microsoft.com/en-us/azure/cosmos-db/local-emulator) instead of MongoDB.
